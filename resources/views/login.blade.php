            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" action="" method="POST">
                  ...
                  <div class="mb-2">
                    <a href="{{route('auth/google/redirect')}}" class="btn btn-block btn-google auth-form-btn">
                      <i class="mdi mdi-google me-2"></i>Connect using Google </a>
                  </div>
                  <div class="mb-2">
                    <a href="{{route('auth/facebook/redirect')}}" class="btn btn-block btn-facebook auth-form-btn">
                      <i class="mdi mdi-facebook me-2"></i>Connect using Facebook </a>
                  </div>
